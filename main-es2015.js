    ...
    ["main"], {
        ...
        "./src/app/chat/chat-bar/chat-bar.component.ts":
            ...
            (function (module, __webpack_exports__, __webpack_require__) {
                ...
                let ChatMessageBar = class ChatMessageBar {
        ...
        "./src/app/controls/control-leader-table/control-leader-table.component.ts":
            ...
            (function (module, __webpack_exports__, __webpack_require__) {
                ...
                let LeaderTableComponent = class LeaderTableComponent {
                    constructor(http) {
                        this.http = http;
                        this.show = false;
                        this.place = [
                    ...
                    onClick() {
                        this.http
                            ...
                            .subscribe(arrayOfUsers => {
                                ...
                                this.arrayOfRecords = this.arrayOfRecords.filter(el => el.game === "paintTheField");
                                this.show = !this.show;
                            });
                    }
                    getPlace(index) {
                ...
                LeaderTableComponent.ctorParameters = () => [{
        ...
        "./src/app/controls/controls.component.ts":
            ...
            (function (module, __webpack_exports__, __webpack_require__) {
                ...
                let ControlsComponent = class ControlsComponent {
                    constructor(GameService, LoginService) {
        ...
        "./src/app/game-field/cell/cell.component.ts":
            ...
            (function (module, __webpack_exports__, __webpack_require__) {
                ...
                let GameCell = class GameCell {
                    constructor(GameService) {
                        this.GameService = GameService;
                    }
                };
                GameCell.ctorParameters = () => [{
        ...
        "./src/app/game-field/color-panel/color-panel.component.ts":
            ...
            (function (module, __webpack_exports__, __webpack_require__) {
                ...
                let ColorPanel = class ColorPanel {
                    constructor(GameService) {
                        this.GameService = GameService;
                    }
                    onClick(color) {
        ...
        "./src/app/game-field/game-difficulty/game-difficulty.component.ts":
            ...
            (function (module, __webpack_exports__, __webpack_require__) {
                ...
                let GameDifficultyComoponent = class GameDifficultyComoponent {
                    constructor(GameService) {
                        this.GameService = GameService;
                    }
                ...
                GameDifficultyComoponent.ctorParameters = () => [{
                    type: src_app_shared_game_service__WEBPACK_IMPORTED_MODULE_2__["GameService"]
                }];
        ...
        "./src/app/game-field/game-filed.component.ts":
            ...
            (function (module, __webpack_exports__, __webpack_require__) {
                ...
                let GameFiled = class GameFiled {
                    constructor(GameService) {
                        this.GameService = GameService;
                    }
                };
                GameFiled.ctorParameters = () => [{
                    type: _shared_game_service__WEBPACK_IMPORTED_MODULE_2__["GameService"]
                }];
